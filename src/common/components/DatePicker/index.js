...
class DatePicker extends Component {
    ...
    render() {
        ...
        const { className, labelText, labelPosition, item, placeholder, disabled, showClearDate, isRTL, orientation, anchorDirection, withPortal, withFullScreenPortal, ...props } = this.props
        ...
        return (
            <Fragment>
                <DatePickerStyle className={addAllClasses.join(' ')}>
                    <label>
                        {position === 'left' || position === 'right' || position === 'top' ? LabelField : null}
