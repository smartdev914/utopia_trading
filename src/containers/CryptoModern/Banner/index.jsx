...
const copyToClipboard = () => {
    navigator.clipboard.writeText('0x391748379827340DB2daFFC845AC6Cffad431B50')
                ...
                <Fade up delay={100}>
                    ...
                    <div className="tooltip">
                        <div role="button" className="contract-address" onClick={copyToClipboard} onMouseOut={setClipboardTooltip}>
                            ...
                            <Text as="span" className="highlight" content="0x391748379827340DB2daFFC845AC6Cffad431B50" /> <Image src="/assets/image/icons/copyIcon2.png" width={20} height={20} />
                        </div>
                    </div>
                </Fade>
                <Fade up delay={150}>
                    <ButtonGroup>
                        <Link href="/exchange">
                            <Button className="text exchange" variant="textButton" title="EXCHANGE" />
                        </Link>
                        <Link href="https://pancakeswap.finance/swap?outputCurrency=0x391748379827340DB2daFFC845AC6Cffad431B50">
                            <Button className="primary buy" title="BUY UTOPIA" />
                        </Link>
                    </ButtonGroup>
                </Fade>
            </BannerContent>
