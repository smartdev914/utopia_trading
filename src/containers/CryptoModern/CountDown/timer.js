    ...
    render() {
        ...
        return (
            <div className={'NormalClock'}>
                ...
                <NormalUnitContainer countdown={countdown} unit={'hours'} digit={hours} />
                {divider ? <span className="dividerColon">:</span> : ''}
                <NormalUnitContainer countdown={countdown} unit={'minutes'} digit={minutes} />
                {divider ? <span className="dividerColon">:</span> : ''}
                <NormalUnitContainer countdown={countdown} unit={'seconds'} digit={seconds} />
            </div>
        )
    }
}
